...
var verifyPassword = function (password, passwordDB) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bcrypt_1.default.compare(password, passwordDB)];
            case 1:
                result = _a.sent();
...
var generateToken = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, jsonwebtoken_1.default.sign(payload, index_1.default.auth.jwt_secret, {
                    expiresIn: '90d'
                })];
...
var verifyToken = function (token) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, jsonwebtoken_1.default.verify(token, index_1.default.auth.jwt_secret)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };

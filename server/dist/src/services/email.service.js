...
var EmailService = /** @class */ (function () {
    ...
    EmailService.prototype.newmailjet = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var transport, json, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        transport = nodemailer_1.default.createTransport((0, nodemailer_smtp_transport_1.default)({
                            host: "in.mailjet.com",
                            port: 2525,
                            auth: {
                                user: process.env.MAILJET_API_KEY || "50877fd9f0e6d0a3ee9528c48fafabf5",

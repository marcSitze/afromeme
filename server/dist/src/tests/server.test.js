...
beforeEach(function (done) {
    (0, dbConfig_1.default)(config_1.default.mongo.MONGO_TEST_DB);
    done();
});
...
test("GET /api/users", function () { return __awaiter(void 0, void 0, void 0, function () {
    var user, newUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                newUser = _a.sent();
                return [4 /*yield*/, (0, supertest_1.default)(index_1.default).get("/api/users")
                        .expect(200)
